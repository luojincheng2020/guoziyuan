...
class IndexViewController: TableBaseViewController,FSSegmentTitleViewDelegate,FSPageContentViewDelegate{
   var login:UIButton?
   var img:YLImageView?
   var titleView:FSSegmentTitleView?
    ...
    func addNavRightBtn(_ title: String) -> UIBarButtonItem {
        ...
        btnRigth?.setTitle(title, for: UIControlState())
        btnRigth?.setTitleColor(blackColor, for: UIControlState())
        btnRigth?.addTarget(self, action: #selector(IndexViewController.cityClick), for: UIControlEvents.touchUpInside)
...
//            tableView = BaseTableView(frame: CGRect(x: 0, y: -64, width: view.bounds.width, height: SCREENHEIGHT-44+64), style: .plain)
//            
...
//            view.addSubview(tableView!)
        ...
        super.setupSubViews(rect:CGRect(x: 0, y: -20, width: view.bounds.width, height: SCREENHEIGHT-44+20),style: UITableViewStyle.plain, isShowHead: true,isShowFooter: true)
...
//        navigationItem.leftBarButtonItem =  addNavRightBtn("扫码")
//
...
//    
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        titleView = FSSegmentTitleView(frame: CGRect(x: 0, y: 0, width: view.bounds.width, height: 50), titles: ["全部123", "葡萄", "猕猴桃", "苹果", "香蕉", "西瓜", "芒果","梨"], delegate: self, indicatorType: FSIndicatorTypeEqualTitle)
...
//        isCityClick = false
        ...
        if drawView == nil {
            ...
            drawView?.arr = ["马陆葡萄园7月10正式上市了","猕猴桃8月20开始订购了","苹果园7月20正式上市了","西瓜5月10正式上市了","更多水果敬请期待"];
            drawView?.speed = 0.5
