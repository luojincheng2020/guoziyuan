...
//    self.placeHolderColor = [UIColor lightGrayColor];
    self.placeHolderColor = [UIColor colorWithRed:200 / 255.0 green:200 / 255.0 blue:200 / 255.0 alpha:1.0];
    self.placeHolderHighlightColor = [UIColor greenColor];
    self.placeHolderErrorColor = [UIColor redColor];
    
//    [self.layer addSublayer:self.borderLayer];
//    self.layer.borderColor = [UIColor colorWithRed:102 / 255.0 green:102 / 255.0 blue:102 / 255.0 alpha:1.0].CGColor;
    self.borderLayer.borderColor =  [UIColor colorWithRed:200 / 255.0 green:200 / 255.0 blue:200 / 255.0 alpha:1.0].CGColor;
    [self.layer addSublayer:self.borderLayer];
...
//        self.textField.secureTextEntry = !self.textField.secureTextEntry;
        if (self.textField.secureTextEntry) {
            ...
            self.tipsIV.image = [UIImage imageNamed:@"new-show"];
            
        }else{
            self.textField.secureTextEntry = YES;
            self.tipsIV.image = [UIImage imageNamed:@"new-hide"];
        }
