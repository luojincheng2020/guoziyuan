...
class FSScrollContentViewController: TableViewController{
...
//        self.view.addSubview(tableView!)
        super.setupSubViews(rect: CGRect(x: 0, y: 0, width: view.bounds.width, height: SCREENHEIGHT-64-44-50), style: .plain, isShowHead: true,isShowFooter: true)
